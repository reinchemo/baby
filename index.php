...
<body >
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>High Quality baby Products</h3>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE THE BABY PRODUCTS SYSTEM <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
           ...
           <div class="row" >
               ...
               <a class="btn btn-info btn-set"  >SLS 2016 Munich Champion</a>
                 ...
                 <hr />
				   ...
				   <br />
               <a class="btn btn-info btn-set"  >Legendary business man</a>
                </div>
                   </div>
